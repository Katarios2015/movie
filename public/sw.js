...
//обработчик события install, который поместит в кэш все статические ресурсы,
// кроме файла с самим сервис-воркером. Браузер кэширует его автоматически;
...
//обработчик события activate, который на каждую активацию 
//сервис-воркера будет удалять с компьютера пользователя устаревшие кэши.
...
//обработчик события fetch, который будет возвращать из кэша 
//файл, если таковой в нём имеется, чтобы не загружать файл с сервера ещё раз;